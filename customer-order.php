                                ...
                                <div class="flex flex-col md:flex-row gap-6 items-center md:items-start">
                                    ...
                                    <div class="flex-grow w-full flex flex-col justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-3">
                                            <a href="download-invoice.php?payment_id=<?php echo $order['payment_id']; ?>" target="_blank" class="text-xs font-bold uppercase tracking-widest text-surfaceDark dark:text-white hover:text-primary dark:hover:text-indigo-400 transition-colors flex items-center gap-2 bg-slate-50 dark:bg-slate-900 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-primary/30">
                                                <span class="material-symbols-outlined text-[18px]">receipt_long</span> Invoice
                                            </a>
                                            <a href="product.php?id=<?php echo $first_item['product_id']; ?>" class="text-xs font-bold uppercase tracking-widest text-white transition-colors flex items-center gap-2 bg-primary hover:bg-primaryHover dark:bg-indigo-600 dark:hover:bg-indigo-500 px-5 py-2.5 rounded-xl shadow-sm border border-transparent">
