...
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<a href="index.php"><img src="assets/uploads/<?php echo $logo; ?>" class="existing-photo" alt="new logo"></a>
			...
			<div class="col-md-5 right">
				<ul>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_19; ?> (₹<?php
