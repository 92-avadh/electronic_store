...
// Fetch Recent Orders (Limit to 5 now that it's full width)
$statement_recent = $pdo->prepare("SELECT * FROM tbl_payment WHERE customer_email=? ORDER BY id DESC LIMIT 5");
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                                        <td class="px-6 py-6">
                                            <div class="flex items-center gap-4">
                                                <div class="w-12 h-12 bg-surface dark:bg-slate-900 rounded-xl flex items-center justify-center text-primary dark:text-indigo-400 border border-slate-200 dark:border-slate-700">
