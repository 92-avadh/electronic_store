...
<head>
    ...
    <title>Admin Access | SILICON SLATE</title>
...
<body class="bg-surface text-on-surface min-h-screen flex flex-col">
    ...
    <header class="sticky top-0 z-50 bg-[#faf8ff]/70 backdrop-blur-xl flex justify-center items-center w-full py-8 px-8">
        <div class="flex items-center gap-2">
            <span class="text-xl font-black text-[#131b2e] tracking-[0.05em] uppercase headline-font">SILICON SLATE</span>
                ...
                <form action="" method="post" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input name="email" class="w-full pl-11 pr-4 py-3.5 bg-surface-container-lowest border-none rounded-lg focus:ring-2 focus:ring-surface-tint/20 transition-all text-sm text-on-surface placeholder:text-outline/50 outline-none" placeholder="name@siliconslate.tech" type="email" autofocus autocomplete="off" required/>
                        </div>
                    </div>
    ...
    <footer class="w-full py-12 flex flex-col items-center justify-center gap-4 bg-[#faf8ff]">
        ...
        <p class="text-slate-400 font-['Inter'] text-xs tracking-wider uppercase">© 2024 SILICON SLATE ADMIN. PRECISION INSTRUMENTATION.</p>
    </footer>
</body>
</html>